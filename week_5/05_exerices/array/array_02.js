...
let common = student1Courses.find((element) =>
...
for (let item of furniture) {
  ...
  console.log(`Letters in '${item}': ${letters}`);
}
...
*/
// Write your code here
console.log(temperatures.filter((element) => element > 0));
